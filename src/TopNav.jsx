...
// — they get a single link back into the app instead. The brand mark links
// to "/" (this same marketing page); the button below is what leads into
// the app ("/home" for students, "/admin" for staff).
    ...
    <header className="sticky top-0 z-40 border-b border-slate-100 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {token ? (
            <Link to={isAdmin ? '/admin' : '/home'} className="btn-primary px-3 py-2 text-xs sm:px-4 sm:py-2.5 sm:text-sm">
